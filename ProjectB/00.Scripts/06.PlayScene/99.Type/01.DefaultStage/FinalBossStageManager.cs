...
public class FinalBossStageManager : DefaultStageManager
{
    protected override void Awake()
    {
        base.Awake();

        StageData stageData = BackEndServerManager.instance.GetSavedResourceData<StageData>(SceneSettingManager.instance.BossSectorType[SceneSettingManager.instance.GetNowBossSectorNum()], isCopy: true);
