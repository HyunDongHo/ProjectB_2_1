...
public class Enemy_Stage_01_H_Control : EnemyControl
{
    ...
    {
        return "Enemy_ST01_001_Death";
    }

    public override string GetHit()
    {
        return "Enemy_ST01_001_Hit_Front";
    }

    protected override string GetWalk()
    {
        return "Enemy_ST01_Walk";
    }

    protected override string GetRun()
    {
        return "Enemy_ST01_Run";
    }
}
