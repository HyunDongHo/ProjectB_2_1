...
using UnityEngine;
using static BackendData.Rank.RankTableItem;
...
namespace BackendData.Rank {
    ...
    public class RankTableItem {
        ...
        public IReadOnlyList<RankUserItem> UserList => (IReadOnlyList<RankUserItem>)_userList.AsReadOnlyList();
        ...
        public void GetRankList(GetListFunc getListFunc) {
            ...
            if ((DateTime.UtcNow - UpdateTime).Minutes < Define.RankUpdateMinTime) {
        ...
        public void GetMyRank(GetMyRankFunc getMyRankFunc) {
            ...
            if ((DateTime.UtcNow - MyRankUpdateTime).Minutes < Define.RankUpdateMinTime)
            {
                if (getMyRankFunc != null)
          ...
          //                 }
          //
          //                 if(StaticManager.Backend.GameData.PlayerGameData.DWarriorLevel < Define.RankUpdageMinLevel)
          //                 {
          //                     MyRankUpdateTime = DateTime.UtcNow;
          //                     return;
          //                 }
