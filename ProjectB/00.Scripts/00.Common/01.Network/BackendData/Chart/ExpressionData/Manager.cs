...
namespace BackendData.Chart.Expression
{
    ...
    public class Manager : Base.Chart {
        ...
        private readonly Dictionary<Define.ExpressionType, Item> _dictionary = new();
        
        // 다른 클래스에서 Add, Delete등 수정이 불가능하도록 읽기 전용 Dictionary
        public IReadOnlyDictionary<Define.ExpressionType, Item> Dictionary => (IReadOnlyDictionary<Define.ExpressionType, Item>)_dictionary.AsReadOnlyCollection();
        ...
        protected override void LoadChartDataTemplate(JsonData json) {
            foreach (JsonData eachItem in json) {
                ...
                _dictionary.Add(info.ExpressionType, info);
            }
        }

        public Item FindItem(Define.ExpressionType expressionType)
        {
            Item item = null;

            Dictionary.TryGetValue(expressionType, out item);
