...
namespace BackendData.Chart.Treasure
{
    ...
    public class Manager : Base.Chart {
        ...
        readonly Dictionary<string, Sprite> _treasureImages = new();
        ...
        protected override void LoadChartDataTemplate(JsonData json) {
            foreach (JsonData eachItem in json) {
                ...
                info.Sprite = base.AddOrGetImageDictionary(_treasureImages, "" , info.ItemSprite);
            }
        }

        public Item GetTreasureItem(int id)
        {
            Item item = null;
