...
namespace BackendData.Chart.PlayerPassiveSkillData
{
    //===============================================================
    ...
    public class Manager : Base.Chart {
        ...
        public Dictionary<int, Item> GetPlayerPassiveSkillItem(int playerType)
        {
            Dictionary<int, Item> _playerItem = new();
            foreach (var item in Dictionary)
            {
                if(item.Value.PlayerType == playerType)
                {
                    _playerItem.Add(item.Value.ItemID, item.Value);
                }
            }
            return _playerItem;
        }
        ...
        //public List<int> GetPlayerSkillMaxLevel(int playerType)
        //{
        //    List<int> _playerItem = new();
        //    foreach (var item in Dictionary)
        //    {
        //        if (item.Value.PlayerType == playerType)
        //        {
        //            _playerItem.Add(item.Value.MaxLevel);
        //        }
        //    }
        //    return _playerItem;
        //}
